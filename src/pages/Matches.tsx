...
export function Matches() {
  ...
  // Dynamic team names from club context
  const TEAM_NAMES: Record<InternalTeam, string> = useMemo(() => ({
    team_a: club?.team_a_name || 'Team A',
    team_b: club?.team_b_name || 'Team B',
  }), [club?.team_a_name, club?.team_b_name]);
  ...
  const handleAddMatch = async (e: React.FormEvent) => {
    ...
    const opponentName = formData.match_type === 'internal'
      ? `${TEAM_NAMES.team_a} vs ${TEAM_NAMES.team_b}`
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      ...
                      {match.match_type === 'internal' && match.winning_team && (
                        <Badge
                          variant="success"
                          className={match.winning_team === 'team_a'
            ...
            {formData.match_type === 'external' ? (
              ...
              <div className="flex items-end">
                <div className="text-sm text-gray-500 dark:text-gray-400 pb-2">
                  Internal match between club teams
                </div>
              </div>
            )}
          </div>
                  ...
                  {formData.result === 'won' && (
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <button
                          type="button"
                          onClick={() => setFormData({ ...formData, winning_team: 'team_a' })}
                          className={`p-3 rounded-xl border-2 transition-all ${
                            formData.winning_team === 'team_a'
                              ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20'
                              : 'border-gray-200 dark:border-gray-700'
                          }`}
                        >
                          <span className="font-medium text-blue-700 dark:text-blue-300">{TEAM_NAMES.team_a}</span>
                        </button>
                        <button
                          type="button"
                          onClick={() => setFormData({ ...formData, winning_team: 'team_b' })}
                          className={`p-3 rounded-xl border-2 transition-all ${
                            formData.winning_team === 'team_b'
                              ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/20'
                              : 'border-gray-200 dark:border-gray-700'
                          }`}
                        >
                          <span className="font-medium text-purple-700 dark:text-purple-300">{TEAM_NAMES.team_b}</span>
                        </button>
                      </div>
                    </div>
                  )}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border-2 border-blue-200 dark:border-blue-800 rounded-xl p-3 bg-blue-50/50 dark:bg-blue-900/10">
                  <h4 className="font-semibold text-blue-700 dark:text-blue-300 mb-2 text-sm">
                    {TEAM_NAMES.team_a} ({getPlayersByTeam('team_a').length})
                  </h4>
                  <div className="space-y-1 max-h-32 overflow-y-auto">
                    {getPlayersByTeam('team_a').map(memberId => {
                ...
                <div className="border-2 border-purple-200 dark:border-purple-800 rounded-xl p-3 bg-purple-50/50 dark:bg-purple-900/10">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2 text-sm">
                    {TEAM_NAMES.team_b} ({getPlayersByTeam('team_b').length})
                  </h4>
                  <div className="space-y-1 max-h-32 overflow-y-auto">
                    {getPlayersByTeam('team_b').map(memberId => {
                      const member = members.find(m => m.id === memberId);
                      return member ? (
                ...
                <div className="max-h-40 overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-lg p-2 space-y-1">
                  {filteredMembers.filter(m => !playerTeams[m.id]).map(member => (
                    <div key={member.id} className="flex items-center gap-2 px-2 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-800 rounded">
                      ...
                      <button
                        type="button"
                        onClick={() => setPlayerTeam(member.id, 'team_a')}
                      ...
                      <button
                        type="button"
                        onClick={() => setPlayerTeam(member.id, 'team_b')}
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4">
            ...
            <p className="font-semibold text-gray-900 dark:text-white">
              {selectedMatch?.match_type === 'internal'
                ? `${TEAM_NAMES.team_a} vs ${TEAM_NAMES.team_b} at ${selectedMatch?.venue}`
              ...
              {resultData.result === 'won' && (
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      onClick={() => setResultData({ ...resultData, winning_team: 'team_a' })}
                      className={`p-3 rounded-xl border-2 transition-all ${
                        resultData.winning_team === 'team_a'
                          ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20'
                          : 'border-gray-200 dark:border-gray-700'
                      }`}
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => setResultData({ ...resultData, winning_team: 'team_b' })}
                      className={`p-3 rounded-xl border-2 transition-all ${
                        resultData.winning_team === 'team_b'
                          ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/20'
                          : 'border-gray-200 dark:border-gray-700'
                      }`}
                    >

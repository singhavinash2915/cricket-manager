...
export function Settings() {
  ...
  const handleExportJSON = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `cm-data-${new Date().toISOString().split('T')[0]}.json`;
  ...
  const handleExportCSV = async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `cm-data-${new Date().toISOString().split('T')[0]}.csv`;
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500 mb-4">
              A modern web application for managing members, matches, and finances of {club!.name}. Built with React, TypeScript, and Supabase.
            </p>
            <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
              <p className="text-sm text-gray-500">
                Powered by <span className="font-medium text-gray-700 dark:text-gray-300">Cricket Manager</span>
              </p>
            </div>
          </CardContent>
        </Card>

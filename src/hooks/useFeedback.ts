...
export function useFeedback() {
  ...
  const submitFeedback = async (data: { name: string; message: string; rating?: number }) => {
  ...
  return {
    feedback, loading, error, fetchFeedback,
    submitFeedback, replyToFeedback, deleteFeedback,
  };
}
